...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="WithSeries_GetResponse_seasons"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::KozshTheMovieDbApi.v3.Tv.Item.WithSeries_GetResponse_seasons CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::KozshTheMovieDbApi.v3.Tv.Item.WithSeries_GetResponse_seasons();
        }
        /// <summary>
