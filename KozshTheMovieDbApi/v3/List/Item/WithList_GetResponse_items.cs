...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="WithList_GetResponse_items"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="WithList_GetResponse_items"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::KozshTheMovieDbApi.v3.List.Item.WithList_GetResponse_items CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::KozshTheMovieDbApi.v3.List.Item.WithList_GetResponse_items();
        }
        /// <summary>
